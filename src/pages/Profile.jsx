...
const UserProfile = () => {
    ...
    return (
        <section className="profile container p-4">
            ...
            <div className="statistics-card-wrapper grid grid-cols-2 gap-2 mb-6">
                <div className="statistics-card bg-gray-800 text-primary rounded-xl p-4 flex items-center gap-4 font-bold text-lg">
                    <img src="/assets/icons/profile/fire.svg" alt="fire icon" />
                    <div className="statistics-card-info flex flex-col gap-1">
                        <p>{user.burningDays}</p>
                        <p className="secondary-text">Shock mode</p>
                    </div>
                </div>
                ...
                <div className="statistics-card bg-gray-800 text-primary rounded-xl p-4 flex items-center gap-4 font-bold text-lg">
                    ...
                    <div className="statistics-card-info flex flex-col gap-1">
                        ...
                        <p className="secondary-text">XP points</p>
                    </div>
                </div>

                <div className="statistics-card bg-gray-800 text-primary rounded-xl p-4 flex items-center gap-4 font-bold text-lg">
                    <img alt="gold icon" style={{ width: '32px' }} />
                    <div className="statistics-card-info flex flex-col gap-1">
                        <p>{user.currentLeague}</p>
                        <p className="secondary-text">Current league</p>
                    </div>
                </div>
                ...
                <div className="statistics-card bg-gray-800 text-primary rounded-xl p-4 flex items-center gap-4 font-bold text-lg">
                    ...
                    <div className="statistics-card-info flex flex-col gap-1">
                        <p>{user.taskCompleted}</p>
                        <p className="secondary-text">Task completed</p>
                    </div>
                </div>
            </div>

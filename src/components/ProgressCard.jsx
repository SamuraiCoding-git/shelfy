...
const ProgressCard = ({ progress }) => {
    ...
    return (
        <div className="bg-blue-500 text-white rounded-3xl p-4 shadow-lg">
            ...
            <div className="mt-4">
                ...
                <div className="relative w-full h-2 bg-black rounded-full mt-2">
                    ...
                    {/* Circle indicator */}
                    <div
                        className="absolute top-1/2 transform -translate-y-1/2 bg-white border-2 border-blue-500 rounded-full"
                        style={{
                            width: '16px',
                            height: '16px',
